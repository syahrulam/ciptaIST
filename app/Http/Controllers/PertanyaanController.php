...
class PertanyaanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content\TesPreferensi\Pertanyaan',compact('systemusergroup'));
    }
    ...
    public function addpertanyaan(Request $request)
    {
        ...
        return view('content\TesPreferensi\TambahPertanyaan',compact('systemusergroup', 'systemmenu'));
    }

    public function processAddpertanyaan(Request $request)
    {
    ...
    public function editpertanyaan($user_group_id)
    {
    ...
    public function processEditpertanyaan(Request $request)
    {
        $fields = $request->validate([
    ...
    public function deletepertanyaan($user_group_id)
    {
