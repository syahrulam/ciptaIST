...
@section('content')
    ...
    <h3 class="page-title">
        <b>Tambah Hasil Test IST</b> <small>Mengelola Hasil Test IST</small>
    </h3>
    <br />
    @if (session('msg'))
    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            <h5 class="mb-0 float-left">
                Form Tambah Hasil Test IST
            </h5>
            <div class="float-right">
                <button onclick="location.href='{{ url('hasiltesist') }}'" name="Find" class="btn btn-sm btn-info"
