...
@section('content')
    ...
    <h3 class="page-title"><br>
        <b>Hasil Test IST</b> <small>Kelola Hasil Test IST</small>
    </h3>
    <br />
    @if (session('msg'))
    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            ...
            <div class="form-actions float-right">
                <button onclick="location.href='{{ url('hasiltesist-tambah') }}'" name="Find" class="btn btn-sm btn-info"
        ...
        <div class="card-body">
            <div class="form-actions float-right">
                <form action="/hasiltestist/cari-hasiltestist" method="GET">
                    ...
                    <tbody id="listdatates">
                        @foreach ($tb_datates as $a)
                            <tr>
                                ...
                                <td>{{ $a->tujuanujian }}</td>
                                <td>
                                    <a href="/hasiltestist/{{ $a->id }}/edit-hasiltestist"
                                        class="btn btn-outline-warning btn-sm">Edit</a>
                                    <a href="/hasiltestist/{{ $a->id }}/hapus-hasiltestist"
