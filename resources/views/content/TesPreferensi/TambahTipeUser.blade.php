...
@section('content')
    ...
    <h3 class="page-title">
        <b>Tambah Tipe Pengguna</b> <small>Mengelola Pengguna</small>
    </h3>
    <br />
    @if (session('msg'))
    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            <h5 class="mb-0 float-left">
                Form Tambah Tipe User
            </h5>
            <div class="float-right">
                <button onclick="location.href='{{ url('user') }}'" name="Find" class="btn btn-sm btn-info"
        ...
        <form method="post" action="/user-prosestambah" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-md-6">
                        <div class="form-group">
                            <a class="text-dark">Nama Tipe Pengguna<a class='red'> *</a></a>
                            <input class="form-control input-bb" type="text" name="namatipeuser" id="namatipeuser"
                                value="{{ old('namatipeuser') }}" />
