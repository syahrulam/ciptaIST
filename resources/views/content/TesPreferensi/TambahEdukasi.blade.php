...
@section('content')
    ...
    <h3 class="page-title">
        <b>Tambah Edukasi</b> <small>Mengelola Edukasi</small>
    </h3>
    <br />
    @if (session('msg'))
    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            ...
            <div class="float-right">
                <button onclick="location.href='{{ url('edukasi') }}'" name="Find" class="btn btn-sm btn-info"
        ...
        <form method="post" action="/edukasi-prosestambah" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-md-6">
                        <div class="form-group">
                            <a class="text-dark">Nama Edukasi<a class='red'> *</a></a>
                            <input class="form-control input-bb" type="text" name="namaedukasi" id="namaedukasi"
                                value="{{ old('namaedukasi') }}" />
