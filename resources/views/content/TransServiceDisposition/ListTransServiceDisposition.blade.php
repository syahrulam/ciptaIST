...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Norma IST</li>
        </ol>
    </nav>
...
@section('content')
    ...
    <h3 class="page-title">
        <b>Daftar Norma IST</b> <small>Mengelola Norma IST</small>
    </h3>
    <br />
    <div id="accordion">
    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            ...
            <div class="form-actions float-right">
                <button onclick="location.href='{{ url('trans-service-disposition/add') }}'" name="Find"
                    class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Norma IST
                    Baru </button>
            </div>
        </div>
                ...
                <table id="example" style="width:100%"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="15%" style='text-align:center'>Usia Norma IST Berakhir</th>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a type="button" class="btn btn-outline-info btn-sm"
                                        href="{{ url('/trans-service-disposition/detail/' . $service['service_disposition_id']) }}">Detail</a>
                                    <?php if($service['approved_status']==0){?>
                                    <a type="button" class="btn btn-outline-warning btn-sm"
                                        href="{{ url('/trans-service-disposition/edit/' . $service['service_disposition_id']) }}">Edit</a>
                                    <?php }else if($service['approved_status']==2){ ?>
                                    <a type="button" class="btn btn-outline-warning btn-sm"
                                        href="{{ url('/trans-service-disposition/edit/' . $service['service_disposition_id']) }}">Edit</a>
                                    <?php } ?>
