    ...
    <div class="card border border-dark">
        <div class="card-header border-dark bg-dark">
            ...
            <div class="float-right">
                <button onclick="location.href='{{ url('system-user-group') }}'" name="Find" class="btn btn-sm btn-info"
        ...
        <form method="post" action="{{ route('process-edit-system-user-group') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="user_group_name" id="user_group_name"
                                value="{{ $systemusergroup['user_group_name'] }}" />
                            <input class="form-control input-bb" type="hidden" name="user_group_id" id="user_group_id"
                                value="{{ $systemusergroup['user_group_id'] }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <a class="text-dark">User Group Level<a class='red'> *</a></a>
                            <input class="form-control input-bb" type="text" name="user_group_level"
                                id="user_group_level" value="{{ $systemusergroup['user_group_level'] }}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" style="padding-left: 3%;">
                        ...
                        <a onclick="uncheck_all()" name="Find" class="btn btn-sm btn-info" title="Back"> UnCheck
                            All</a>
                    </div>
                </div>
                <hr style="margin:0;">
            ...
            ?>
                <div class="indent_first">
                    <input type='checkbox' class='checkboxes' name='checkbox_{{ $val['id_menu'] }}'
                        id='checkbox_{{ $val['id_menu'] }}' value='1'
                        OnClick='checkboxSalesOrderChange({{ $val['id_menu'] }})'; checked /> {{ $val['text'] }}
                </div>
                <?php   }else if($val['indent_level']==1 && $SystemUserGroup->getMenuMappingStatus($systemusergroup['user_group_level'], $val['id_menu'])==0){ ?>
                <div class="indent_first">
                    <input type='checkbox' class='checkboxes' name='checkbox_{{ $val['id_menu'] }}'
                        id='checkbox_{{ $val['id_menu'] }}' value='1'
                        OnClick='checkboxSalesOrderChange({{ $val['id_menu'] }})'; /> {{ $val['text'] }}
                </div>
