                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="hidden" name="user_id" id="user_id"
                                value="{{ $user_id }}" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="full_name" id="full_name"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="phone_number" id="phone_number"
                                value="{{ $systemuser['phone_number'] }}" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <a class="text-dark">User Group<a class='red'> *</a></a>
                        <br />
                        {!! Form::select('user_group_id', $systemusergroup, $systemuser['user_group_id'], [
                    ...
                    <div class="col-md-4">
                        ...
                        <br />
                        {!! Form::select('section_id', $coresection, $systemuser['section_id'], [
                            'class' => 'selection-search-clear select-form',
                        ]) !!}
                    </div>
                </div>
