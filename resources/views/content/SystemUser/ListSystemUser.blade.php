    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            ...
            <div class="form-actions float-right">
                <button onclick="location.href='{{ url('system-user/add') }}'" name="Find" class="btn btn-sm btn-info"
                    title="Add Data"><i class="fa fa-plus"></i> Tambah System User Baru</button>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a type="button" class="btn btn-outline-warning btn-sm"
                                        href="{{ url('/system-user/edit/' . $user['user_id']) }}">Edit</a>
                                    <a type="button" class="btn btn-outline-danger btn-sm"
                                        href="{{ url('/system-user/delete-system-user/' . $user['user_id']) }}">Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
