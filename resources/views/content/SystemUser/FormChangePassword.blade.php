    ...
    <div class="card border border-dark">
        <div class="card-header border-dark bg-dark">
            ...
            <div class="float-right">
                <button onclick="location.href='{{ url('home') }}'" name="Find" class="btn btn-sm btn-info"
                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="password" name="new_password" id="new_password"
                                value="" required>
                        </div>
                    </div>
                </div>
