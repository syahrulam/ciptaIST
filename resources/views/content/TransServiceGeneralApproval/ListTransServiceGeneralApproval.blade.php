...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Daftar Jenis Pengguna</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Daftar Jenis Pengguna</b> <small>Mengelola Jenis Pengguna</small>
</h3>
<br/>
<div id="accordion">
...
<div class="card border border-dark">
    <div class="card-header bg-dark clearfix">
        ...
        <div class="form-actions float-right">
            <button onclick="location.href='{{ url('trans-service-general-approval/search') }}'" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Jenis Pengguna</button>
        </div>
    </div>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="20%" style='text-align:center'>Nama Jenis Pengguna</th>
